...
STORAGE_AZURE_CONNECTION_STRING_FILEPATH: str = config('STORAGE_AZURE_CONNECTION_STRING_FILEPATH')
STORAGE_AZURE_CONTAINER_NAME: str = config('STORAGE_AZURE_CONTAINER_NAME')
STORAGE_AWS_SECRET_FILEPATH: str = config('STORAGE_AWS_SECRET_FILEPATH')
STORAGE_AWS_KEY_STRING: str = config('STORAGE_AWS_KEY_STRING')
STORAGE_AWS_BUCKET_NAME: str = config('STORAGE_AWS_BUCKET_NAME')
